...
<t:pageTemplate pageTitle="Employee Management System">
    ...
    <button type="button"  href="${pageContext.request.contextPath}/Login" class="btn btn-light d-block mx-auto mt-3" style="font-size: 1.5em; margin-left: 350px">Login  → </button>
</t:pageTemplate>